    ...
    public partial class FirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CorsoCodice = table.Column<string>(type: "nchar(3)", fixedLength: true, maxLength: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TitoloStudio = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CorsoCodice = table.Column<string>(type: "nchar(3)", nullable: true),
